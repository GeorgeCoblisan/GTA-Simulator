...
static const yytype_uint8 yyrline[] =
{
     ...
     122,   124,   125,   127,   128,   129,   130,   131,   133,   134,
...
{
  "$end", "error", "$undefined", "play", "choose_character", "get", "job",
  "work", "see", "account_balance", "experience", "cars", "jobs",
  "businesses", "houses", "property", "buy", "car", "house", "go_to",
  "casino", "dice", "bet", "leave", "rob", "party", "business", "check",
  "withdraw", "from", "quit", "sell", "invalid", "value", "name",
  "$accept", "line", "job_topic", "car_topic", "house_topic",
  "business_topic", "casino_topic", "check_topic", "choose_person", YY_NULLPTR
};
#endif
...
{
      -1,   -34,   -34,     0,   -34,   -33,    -3,   -34,     2,    22,
     -14,   -34,   -23,    -7,   -34,   -34,   -12,   -11,    -6,   -34,
     -34,   -34,   -34,   -34,   -34,   -34,   -34,   -34,   -19,   -34,
     -34,   -34,   -34,   -34,   -34,   -34,    -8,    -4,     3,   -34,
     -34,   -34,   -34,     8,   -34,   -34,   -34,   -34,   -34,     5,
     -34
};
...
{
      15,     2,    14,     0,     1,     0,     0,    18,     0,     0,
       0,    29,     0,     4,    13,    11,     0,     0,     0,    12,
       5,     6,     7,     8,     9,    10,     3,    35,     0,    16,
      32,    33,    34,    19,    23,    21,     0,     0,     0,    28,
      30,    31,    25,     0,    27,    17,    20,    22,    24,     0,
      26
};
...
{
       4,    27,     1,    28,     5,     6,    39,     7,     8,    29,
      40,    30,    31,    41,    42,    45,     9,    32,    43,    10,
      44,    11,    12,    13,    14,    15,    46,    16,    17,     2,
      47,    18,    19,    33,    49,    34,    35,    48,    50,    36,
      37,     0,     0,     0,     0,     0,     0,     0,    38
};

static const yytype_int8 yycheck[] =
{
       0,    34,     3,     6,     4,     5,    20,     7,     8,    12,
      33,     9,    10,    20,    26,    34,    16,    15,    29,    19,
      26,    21,    22,    23,    24,    25,    34,    27,    28,    30,
      34,    31,    32,    11,    26,    13,    14,    34,    33,    17,
      18,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    26
};
...
{
       0,     3,    30,    36,     0,     4,     5,     7,     8,    16,
      19,    21,    22,    23,    24,    25,    27,    28,    31,    32,
      37,    38,    39,    40,    41,    42,    43,    34,     6,    12,
       9,    10,    15,    11,    13,    14,    17,    18,    26,    20,
      33,    20,    26,    29,    26,    34,    34,    34,    34,    26,
      33
};
...
#line 1621 "y.tab.c"
  ...
  case 26:
#line 130 "yacc.y"
                                             { withdraw_business((yyvsp[0].integer)); }
#line 1627 "y.tab.c"
    break;
